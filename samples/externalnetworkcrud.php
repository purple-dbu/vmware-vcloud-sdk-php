...
$longs  = array(
    ...
    "vim::",      //-a|--vim      [optional] name of the registered vim server
...
$portGroupMoRef= getPortGroupMoRef($portGroupName, $vimName);
    ...
    echo "Create an external network. \n";
    ...
    // update an external network
    echo "Update an external network. \n";
    ...
    echo "Updated an external network : ".$extnetwork->get_name()."\n";
    ...
    echo "Delete an external network.\n";
...
function usage()
{
    ...
    echo "\n";
    echo "  [Usage]\n";
    echo "     # php externalnetworkcrud.php -s <server> -u <username> -p <password> [Options]\n";
    echo "\n";
    ...
    echo "\n";
    echo "  [Options]\n";
    echo "     -a|--vim <vimName>        [opt] Name of a registered Vim server in the vCloud Director.\n";
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php externalnetworkcrud.php -s 127.0.0.1 -u admin@Org -p password -a=vim -b=net -c=name -d=fence\n";
