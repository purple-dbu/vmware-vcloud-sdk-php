...
function usage()
{
    ...
    echo "\n";
    echo "  [Usage]\n";
    echo "     # php callout.php -s <server> -u <username> -p <password> [Options]\n";
    echo "\n";
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php callout.php -s 127.0.0.1 -u admin@Org -p password -a=10.20.120.140 -g=DefaultOrg -h=vdcUpdateTemplate\n";
