...
$longs  = array(
    ...
    "vim::",      //-b|--vim      [optional] Name of an existing registered Vim server
...
$vimserverRef = VMware_VCloud_SDK_Helper::createReferenceTypeObj($vimRef->get_href());
    ...
    if ($netpooltype== 'portgroup-backed')
    {
        ...
        echo "Updated Portgroup-backed Network Pool : ".$VMWNetworkPool->get_name()."\n";
    ...
    else if($netpooltype== 'vlan-backed')
    {
        ...
        echo "Updated Vlan-backed Network Pool : ".$VMWNetworkPool->get_name()."\n";
        ...
        echo "Delete Vlan-backed Network Pool. \n";
        deleteVMWNetworkPool($poolName);
    }
    else if($netpooltype== 'isolation-backed')
    {
        ...
        echo "Update Isolation-backed Network Pool. \n";
        ...
        echo "Updated Isolation-backed Network Pool : ".$VMWNetworkPool->get_name()."\n";
        ...
        echo "Delete Isolation-backed Network Pool.\n";
        deleteVMWNetworkPool($poolName);
    }
    else
    {
...
function usage()
{
    ...
    echo "\n";
    echo "  [Usage]\n";
    echo "     # php networkpoolcrud.php -s <server> -u <username> -p <password> [Options]\n";
    echo "\n";
    ...
    echo "     -b|--vim <vimName>           [opt] Name of an existing registered Vim server in the vCloud Director.\n";
    ...
    echo "\n";
    echo "  [Examples]\n";
    echo "     # php networkpoolcrud.php -s 127.0.0.1 -u admin@Org -p password -a portgroup-backed -b vim -c pool -d name -e dvswitch\n";
